...
create sequence chainsys_emp_id_seq43 start with 1 increment by 1;
...
create sequence timesheet_timesheet_number_sq start with 1 increment by 1;


put employee id from chainsys table to below.

insert into timesheet(employee_id,ondate,task,timesheet_number,taskstatus,timesheetstatus) values
(employee_id,'01-02-19','Project A module 1',timesheet_timesheet_number_sq.nextval,'--','--');
...
insert into attendance (ondate,employee_id,employee_name,status,present_hours,reason,approval)
values('18-02-19',2009,'Athiselvam','Present',8,'--','--');
insert into attendance (ondate,employee_id,employee_name,status,present_hours,reason,approval)
