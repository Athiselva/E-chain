...
public class ChainsysDAO {
	...
	public Boolean login(Chainsys chainsys) throws SQLException{
		...
		if(resultSet.getString("username").equalsIgnoreCase(chainsys.getUsername()) && resultSet.getString("password").equalsIgnoreCase(chainsys.getPassword())){
	...
	public ArrayList<Chainsys> attendance(Chainsys chainsys) throws SQLException{
		Connection connection = ConnectionUtil.getConnection();
	...
	public ArrayList<Chainsys> viewProfile(Chainsys chainsys) throws SQLException{
		Connection connection = ConnectionUtil.getConnection();
	...
	public ArrayList<Chainsys> viewTimeSheet(Chainsys chainsys) throws SQLException{
		Connection connection = ConnectionUtil.getConnection();
		...
		while(resultSet.next()){
			...
			chainsys2.setTimeSheetStatus(resultSet.getString("timesheetstatus"));
			clist.add(chainsys2);
		}
		ConnectionUtil.close(connection, preparedStatement, resultSet);
		return clist;
	...
	public void timeSheets(Chainsys chainsys) throws SQLException{
		Connection connection = ConnectionUtil.getConnection();
		String sql="update timesheet set Taskstatus=? where employee_id=? and ondate=?";
		PreparedStatement preparedStatement = connection.prepareStatement(sql);
	...
	public ArrayList<Chainsys> ondateTimeSheet(Chainsys chainsys) throws SQLException{
		Connection connection = ConnectionUtil.getConnection();
